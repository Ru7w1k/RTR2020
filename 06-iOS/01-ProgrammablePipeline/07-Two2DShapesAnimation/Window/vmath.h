...
class vecN {
 public:
  ...
  inline vecN operator+(const vecN& that) const {
    my_type result;
    int n;
    for (n = 0; n < len; n++) result.data[n] = data[n] + that.data[n];
    return result;
  }
  ...
  inline vecN operator-() const {
    my_type result;
    int n;
    for (n = 0; n < len; n++) result.data[n] = -data[n];
    return result;
  }
  ...
  inline vecN operator*(const T& that) const {
    my_type result;
    int n;
    for (n = 0; n < len; n++) result.data[n] = data[n] * that;
    return result;
  }
 ...
 protected:
  ...
  inline void assign(const vecN& that) {
    int n;
    for (n = 0; n < len; n++) data[n] = that.data[n];
  }
};
...
class Tquaternion {
 public:
  ...
  inline Tquaternion operator-() const { return Tquaternion(-r, -v); }
  ...
  inline operator Tvec4<T>&() { return *(Tvec4<T>*)&a[0]; }

  inline operator const Tvec4<T>&() const { return *(const Tvec4<T>*)&a[0]; }
...
class matNM {
 public:
  ...
  inline matNM operator+(const my_type& that) const {
    my_type result;
    int n;
    for (n = 0; n < w; n++) result.data[n] = data[n] + that.data[n];
    return result;
  }
  ...
  inline my_type operator*(const T& that) const {
    my_type result;
    int n;
    for (n = 0; n < w; n++) result.data[n] = data[n] * that;
    return result;
  }

  inline my_type& operator*=(const T& that) {
    int n;
    for (n = 0; n < w; n++) data[n] = data[n] * that;
    return *this;
  }

  // Matrix multiply.
  // TODO: This only works for square matrices. Need more template skill to make
  // a non-square version.
  inline my_type operator*(const my_type& that) const {
    my_type result(0);
 ...
 protected:
  ...
  inline void assign(const matNM& that) {
    int n;
    for (n = 0; n < w; n++) data[n] = that.data[n];
  }
};
...
class Tmat4 : public matNM<T, 4, 4> {
 public:
  ...
  inline Tmat4(const vecN<T, 4>& v0, const vecN<T, 4>& v1, const vecN<T, 4>& v2,
               const vecN<T, 4>& v3) {
    base::data[0] = v0;
    base::data[1] = v1;
    base::data[2] = v2;
...
static inline Tmat4<T> lookat(const vecN<T, 3>& eye, const vecN<T, 3>& center,
  ...
  const Tmat4<T> M = Tmat4<T>(
      Tvec4<T>(s[0], u[0], -f[0], T(0)), Tvec4<T>(s[1], u[1], -f[1], T(0)),
      Tvec4<T>(s[2], u[2], -f[2], T(0)), Tvec4<T>(T(0), T(0), T(0), T(1)));
...
static inline Tmat4<T> scale(T x, T y, T z) {
  return Tmat4<T>(Tvec4<T>(x, 0.0f, 0.0f, 0.0f), Tvec4<T>(0.0f, y, 0.0f, 0.0f),
...
static inline Tmat4<T> scale(T x) {
  return Tmat4<T>(Tvec4<T>(x, 0.0f, 0.0f, 0.0f), Tvec4<T>(0.0f, x, 0.0f, 0.0f),
