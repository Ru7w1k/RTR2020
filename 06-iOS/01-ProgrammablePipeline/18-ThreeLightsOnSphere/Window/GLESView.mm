...
- (id)initWithFrame:(CGRect)frame {
  ...
  if (self) {
    ...
    const GLchar *vertexShaderSourceCode_pv =
        (GLchar
             *)"#version 300 es                                                                    "
               ...
               "                                                                                   "
               "                                                 "
               "       vec3 light_direction_red = normalize(vec3(u_light_position_red - "
               "eye_coordinates));                                            "
               ...
               "viewer_vector), 0.0), u_shininess);                "
               "                                                                                   "
               "                                                 "
               "       vec3 light_direction_green = normalize(vec3(u_light_position_green - "
               "eye_coordinates));                                        "
               ...
               "                                                "
               "       vec3 specular_green = u_ls_green * u_ks * "
               "pow(max(dot(reflection_vector_green, viewer_vector), 0.0), u_shininess);           "
               " "
               "                                                                                   "
               "                                                 "
               "       vec3 light_direction_blue = normalize(vec3(u_light_position_blue - "
               "eye_coordinates));                                        "
               ...
               "                                                 "
               "       vec3 specular_blue = u_ls_blue * u_ks * pow(max(dot(reflection_vector_blue, "
               "viewer_vector), 0.0), u_shininess);                "
               "                                                                                   "
               "                                                 "
               "       phong_ads_light = ambient_red + diffuse_red + specular_red;                 "
               "                                                   "
               "       phong_ads_light = phong_ads_light + ambient_green + diffuse_green + "
               "specular_green;                                            "
               "       phong_ads_light = phong_ads_light + ambient_blue + diffuse_blue + "
               "specular_blue;                                            "
               "   }                                                                               "
               "                                                  "
               "   else                                                                            "
    ...
    if (iProgramLinkStatus == GL_FALSE) {
      ...
      if (iInfoLogLength > 0) {
        ...
        if (szInfoLog != NULL) {
          ...
          printf("Shader Linking Info Log: %s", szInfoLog);
          free(szInfoLog);
          [self release];
          exit(0);
        }
    ...
    lightPositionUniform_red_pv =
        glGetUniformLocation(gShaderProgramObject_pv, "u_light_position_red");
    ...
    lightPositionUniform_green_pv =
        glGetUniformLocation(gShaderProgramObject_pv, "u_light_position_green");
    ...
    lightPositionUniform_blue_pv =
        glGetUniformLocation(gShaderProgramObject_pv, "u_light_position_blue");
    ...
    const GLchar *fragmentShaderSourceCode_pf =
        (GLchar *)"#version 300 es"
                  ...
                  "       vec3 diffuse_green  = u_ld_green * u_kd * tn_dot_ldir_green;"
                  "       vec3 specular_green = u_ls_green * u_ks * "
                  "pow(max(dot(reflection_vector_green, nviewer_vector), 0.0), u_shininess);"
                  "                                                                                "
                  "                                            "
                  ...
                  "ambient_green + diffuse_green + specular_green + ambient_blue + diffuse_blue + "
                  "specular_blue;"
                  "       FragColor = vec4(phong_ads_light, 1.0);"
                  "    }"
                  "   else"
    ...
    lightPositionUniform_red_pf =
        glGetUniformLocation(gShaderProgramObject_pf, "u_light_position_red");
    ...
    lightPositionUniform_green_pf =
        glGetUniformLocation(gShaderProgramObject_pf, "u_light_position_green");
    ...
    lightPositionUniform_blue_pf =
        glGetUniformLocation(gShaderProgramObject_pf, "u_light_position_blue");
...
- (void)drawView:(id)sender {
  ...
  if (bFragment == YES) {
    ...
    if (bLight == YES) {
      ...
      glUniform4f(lightPositionUniform_red_pf, 0.0f, 100.0f * cos(lights[0].angle),
      ...
      glUniform4f(lightPositionUniform_green_pf, 100.0f * cos(lights[1].angle), 0.0f,
      ...
      glUniform4f(lightPositionUniform_blue_pf, 100.0f * cos(lights[2].angle),
    ...
    if (bLight == YES) {
      ...
      glUniform4f(lightPositionUniform_red_pv, 0.0f, 100.0f * cos(lights[0].angle),
                  100.0f * sin(lights[0].angle), 1.0f);
      ...
      glUniform4f(lightPositionUniform_green_pv, 100.0f * cos(lights[1].angle), 0.0f,
                  100.0f * sin(lights[1].angle), 1.0f);
      ...
      glUniform4f(lightPositionUniform_blue_pv, 100.0f * cos(lights[2].angle),
                  100.0f * sin(lights[2].angle), 0.0f, 1.0f);
