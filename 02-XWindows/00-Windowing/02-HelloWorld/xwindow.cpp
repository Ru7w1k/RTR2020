...
int main(void)
{
    ...
    XGCValues gcValues;
    XColor greenColor;
    char str[] = "Hello XWindows from Rutwik Choughule";
    int strLen;
    int strWidth;
    int fontHeight;
    ...
    while (1)
    {
        ...
        switch (event.type)
        {
            ...
            case Expose:
                ...
                XDrawString(gpDisplay, gWindow, gc, 
...
void CreateWindow(void)
{
    ...
    winAttribs.background_pixel = BlackPixel(gpDisplay, defaultDepth);
    ...
    XStoreName(gpDisplay, gWindow, "First XWindow - Rutwik Choughule");
