...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,
  ...
  // create window
  hwnd = CreateWindowEx(
      WS_EX_APPWINDOW, szAppName, TEXT("D3D11 | Two 2D Shapes White"),
...
void uninitialize(void) {
  ...
  if (gpID3D11BufferVertexBufferPositionQuad) {
    gpID3D11BufferVertexBufferPositionQuad->Release();
    gpID3D11BufferVertexBufferPositionQuad = NULL;
  }
