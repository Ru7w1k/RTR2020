...
void InitMaterials()
{
	...
	// shininess
	Materials[0][0].MaterialShininess[0] = 0.6f * 128.0f;
	...
	Materials[1][0].MaterialSpecular[3] = 1.0f;     // a
	 ...
	 // shininess
	Materials[1][0].MaterialShininess[0] = 0.1f * 128.0f;
	...
	// shininess
	Materials[2][0].MaterialShininess[0] = 0.3f * 128.0f;
	...
	// shininess
	Materials[3][0].MaterialShininess[0] = 0.088f * 128.0f;
	...
	// shininess
	Materials[4][0].MaterialShininess[0] = 0.6f * 128.0f;
	...
	// shininess
	Materials[5][0].MaterialShininess[0] = 0.1f * 128.0f;
	...
	// shininess
	Materials[0][1].MaterialShininess[0] = 0.21794872f * 128.0f;
	...
	// shininess
	Materials[1][1].MaterialShininess[0] = 0.2f * 128.0f;
	...
	// shininess
	Materials[2][1].MaterialShininess[0] = 0.6f * 128.0f;
	...
	// shininess
	Materials[3][1].MaterialShininess[0] = 0.1f * 128.0f;
	...
	// shininess
	Materials[4][1].MaterialShininess[0] = 0.4f * 128.0f;
	...
	// shininess
	Materials[5][1].MaterialShininess[0] = 0.4f * 128.0f;
	...
	// shininess
	Materials[0][2].MaterialShininess[0] = 0.25f * 128.0f;
	...
	// shininess
	Materials[1][2].MaterialShininess[0] = 0.25f * 128.0f;
	...
	// shininess
	Materials[2][2].MaterialShininess[0] = 0.25f * 128.0f;
	...
	// shininess
	Materials[3][2].MaterialShininess[0] = 0.25f * 128.0f;
	...
	// shininess
	Materials[4][2].MaterialShininess[0] = 0.25f * 128.0f;
	...
	// shininess
	Materials[5][2].MaterialShininess[0] = 0.25f * 128.0f;
	...
	// shininess
	Materials[0][3].MaterialShininess[0] = 0.078125f * 128.0f;
	...
	// shininess
	Materials[1][3].MaterialShininess[0] = 0.078125f * 128.0f;
	...
	// shininess
	Materials[2][3].MaterialShininess[0] = 0.078125f * 128.0f;
	...
	// shininess
	Materials[3][3].MaterialShininess[0] = 0.078125f * 128.0f;
	...
	// shininess
	Materials[4][3].MaterialShininess[0] = 0.078125f * 128.0f;
	...
	// shininess
	Materials[5][3].MaterialShininess[0] = 0.078125f * 128.0f;
}
