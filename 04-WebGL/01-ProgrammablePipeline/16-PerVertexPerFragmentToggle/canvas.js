...
function draw() {
    ...
    if (bFragment) {
        ...
        gl.uniform3f(kdUniformPF, 0.5, 0.5, 0.5);
        gl.uniform4f(lightPositionUniformPF, 0.0, 0.0, 2.0, 1.0);
        ...
        if (bLight) {
            ...
            gl.uniform3f(kdUniformPF, 0.5, 0.2, 0.7);
            gl.uniform3f(ksUniformPF, 0.7, 0.7, 0.7);
        ...
        gl.uniform3f(kdUniformPV, 0.5, 0.5, 0.5);
        gl.uniform4f(lightPositionUniformPV, 0.0, 0.0, 2.0, 1.0);
        ...
        if (bLight) {
            ...
            gl.uniform3f(kdUniformPV, 0.5, 0.2, 0.7);
            gl.uniform3f(ksUniformPV, 0.7, 0.7, 0.7);
