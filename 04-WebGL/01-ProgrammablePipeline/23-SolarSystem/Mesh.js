const WebGLMacros = { // all inside this are const, as this is const
    RMC_ATTRIBUTE_VERTEX: 0,
    RMC_ATTRIBUTE_COLOR: 1,
    RMC_ATTRIBUTE_NORMAL: 2,
    RMC_ATTRIBUTE_TEXCOORD0: 3,
};
...
function Mesh() {
    ...
    this.prepareToDraw = function () {
        ...
        gl.vertexAttribPointer(WebGLMacros.RMC_ATTRIBUTE_VERTEX,
            3,
            gl.FLOAT,
            false, 0, 0);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
            texCoords,
            gl.STATIC_DRAW);
        gl.vertexAttribPointer(WebGLMacros.RMC_ATTRIBUTE_TEXCOORD0,
            2, // 2 is for S,T co-ordinates in our texCoords array
            gl.FLOAT,
            false, 0, 0);
        gl.enableVertexAttribArray(WebGLMacros.RMC_ATTRIBUTE_TEXCOORD0);
        gl.bindBuffer(gl.ARRAY_BUFFER, null);
    ...
    this.draw = function (r, g, b) {
        ...
        // draw
        gl.vertexAttrib3f(WebGLMacros.RMC_ATTRIBUTE_COLOR, r, g, b);
