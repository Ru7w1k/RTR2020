...
void display(void)
{
	...
	glBegin(GL_LINES);
		...
		for (float fOffset = -1.20f; fOffset <= 0; fOffset += (1.20f / 20.0f))
		{
			glVertex3f( -3.0f, fOffset, 0.0f);
			glVertex3f(  3.0f, fOffset, 0.0f);

			glVertex3f( -3.0f, fOffset + 1.20f+(1.20f / 20.0f), 0.0f);
			glVertex3f(  3.0f, fOffset + 1.20f+(1.20f / 20.0f), 0.0f);
		}
