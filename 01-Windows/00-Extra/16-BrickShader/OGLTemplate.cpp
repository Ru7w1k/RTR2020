...
void initialize(void)
{
	...
	const GLchar *vertexShaderSourceCode = 
		...
		"	vec3 lightVec = normalize(vec3(u_LightPosition - eyeCoordinates.xyz)); \n" \
		"	vec3 reflectVec = reflect(-lightVec, tNorm); \n" \
		"	vec3 viewVec = normalize(-eyeCoordinates.xyz); \n" \
		...
		"	out_LightIntensity = DiffuseContribution * diffuse + SpecularContribution * spec; \n" \

		"	gl_Position  = u_pMatrix * u_mvMatrix * vPosition; \n" \
		"	if (vNormal.z != 0.0) \n" \
		"		out_Position = vPosition.xy; \n" \
		"	else if (vNormal.y != 0.0) \n" \
		"		out_Position = vPosition.xz; \n" \
		"	else if (vNormal.x != 0.0) \n" \
		"		out_Position = vPosition.yz; \n" \
		"} \n";
	...
	const GLchar *fragmentShaderSourceCode = 
		...
		"	position = out_Position / BrickSize; \n" \
