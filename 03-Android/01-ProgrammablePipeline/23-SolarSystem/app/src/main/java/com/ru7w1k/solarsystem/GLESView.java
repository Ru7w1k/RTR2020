...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener {
    ...
    private void initialize(GL10 gl) {
        ...
        // set constant color
        GLES32.glVertexAttrib3f(GLESMacros.RMC_ATTRIBUTE_COLOR, 0.5f, 0.35f, 0.05f);
...
// perform necessary transformations
        ...
        GLES32.glVertexAttrib3f(GLESMacros.RMC_ATTRIBUTE_COLOR, 0.4f, 0.9f, 1.0f);
        GLES32.glBindBuffer(GLES32.GL_ELEMENT_ARRAY_BUFFER, vboSphereElm[0]);
        GLES32.glDrawElements(GLES32.GL_TRIANGLES, numElements, GLES32.GL_UNSIGNED_SHORT, 0);
        ...
        GLES32.glVertexAttrib3f(GLESMacros.RMC_ATTRIBUTE_COLOR, 0.9f, 0.9f, 0.9f);
        GLES32.glBindBuffer(GLES32.GL_ELEMENT_ARRAY_BUFFER, vboSphereElm[0]);
        GLES32.glDrawElements(GLES32.GL_TRIANGLES, numElements, GLES32.GL_UNSIGNED_SHORT, 0);
