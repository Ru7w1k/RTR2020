package com.ru7w1k.checkerboard;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener {
    ...
    private void initialize(GL10 gl) {
        ...
        floatBuffer.put(quadTexcoords);
        floatBuffer.position(0);

        // pass to OpenGL buffer
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, quadTexcoords.length * 4, floatBuffer, GLES32.GL_STATIC_DRAW);
        ...
        textureCheckerboard[0] = loadCheckerTexture();
    ...
    private void draw() {
        ...
        Matrix.translateM(translateMatrix, 0, 0.0f, 0.0f, -4.6f);
        ...
        positionBuffer.put(quadsPosition);
        positionBuffer.position(0);

        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vboPos[0]);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, quadsPosition.length * 4, positionBuffer, GLES32.GL_DYNAMIC_DRAW);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
    ...
    private int loadCheckerTexture() {
