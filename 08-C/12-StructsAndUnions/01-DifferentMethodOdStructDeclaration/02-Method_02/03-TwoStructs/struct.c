...
struct MyPoint point_rc; // declaring a single variable of type 'struct MyPoint' globally..

struct MyPointProperties point_properties_rc; // declaring a single variable of type 'struct MyPointProperties' globally..
