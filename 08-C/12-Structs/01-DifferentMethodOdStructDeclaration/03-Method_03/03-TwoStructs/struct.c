...
int main(void)
{
    ...
    struct MyPoint
    {
        int x;
        int y;
    } point_rc; // declaring a single variable of type 'struct MyPoint' locally..
    ...
    } point_properties_rc; // declaring a single variable of type 'struct MyPointProperties' locally..
